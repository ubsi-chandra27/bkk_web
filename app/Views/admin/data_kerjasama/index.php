    ...
    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <form id="kt_modal_add_kerjasama_form" action="<?= site_url('admin/data-kerjasama/store') ?>" method="POST" class="form confirm-submit" enctype="multipart/form-data" data-confirm-title="Tambah Kerja Sama" data-confirm-text="Apakah Anda yakin ingin menambah kerja sama baru?">
                                ...
                                <div class="mb-13 text-center">
                                    ...
                                    <div class="text-muted fw-semibold fs-5">Silakan masukkan Kerja Sama yang akan ditambahkan</div>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                        <span class="required">Nama Kerja Sama</span>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="Contoh: PKL" name="nama_kerjasama" />
                                </div>
            ...
            <div class="modal fade" id="editKerjasamaModal" tabindex="-1" aria-labelledby="editKerjasamaModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content rounded">
                        ...
                        <!--begin::Modal body-->
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <form id="kt_modal_edit_kerjasama_form" action="" method="POST" class="form confirm-submit" enctype="multipart/form-data" data-action-template="<?= site_url('admin/data-kerjasama/update/:id') ?>" data-confirm-title="Edit Kerja Sama" data-confirm-text="Apakah Anda yakin ingin memperbarui data kerja sama?">
                                <?= csrf_field() ?>
                                <div class="mb-13 text-center">
                                    <h1 class="mb-3">Edit Kerja Sama</h1>
                                    <div class="text-muted fw-semibold fs-5">Perbarui Nama Kerja Sama</div>
                                </div>
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" id="editKerjasama" class="form-control form-control-solid" placeholder="Enter Kerja Sama" name="nama_kerjasama" />
                                </div>
                                <div class="text-center">
                                    <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">Batal</button>
                                    <button type="submit" class="btn btn-primary">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-3 px-5 px-md-8">
            <div class="position-relative w-100 w-md-auto">
                ...
                <input type="text" id="searchInput" class="form-control form-control-solid w-100 w-md-250px ps-14" placeholder="Cari Kerja Sama...">
            </div>
            <div class="card-toolbar w-100 w-md-auto">
                <button type="button" class="btn btn-sm btn-primary w-100 w-md-auto" data-bs-toggle="modal" data-bs-target="#addKerjasamaModal">
                ...
                <table id="kt_datatable_example_1" class="table table-hover align-middle gs-0 gy-4">
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            ...
                            <th class="min-w-120px">Kerja Sama</th>
                        ...
                        <?php if (!empty($kerjasama)): ?>
                            ...
                            foreach ($kerjasama as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="text-dark fw-bold text-hover-primary"><?= esc($item['nama_kerjasama']) ?></span>
                                        </div>
                                    </td>
                                    <td class="text-end pe-3">
                                        ...
                                        <a href="<?= site_url('admin/data-kerjasama/delete/' . $item['id']) ?>"
                                            class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn"
                                            data-title="Hapus Kerja Sama"
                                            data-text="Anda akan menghapus kerja sama &quot;<?= esc($item['nama_kerjasama']) ?>&quot;. Tindakan ini tidak dapat dibatalkan!"
                                            title="Hapus">
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<script>
    ...
    $(document).on('click', '[data-bs-target="#editKerjasamaModal"]', function() {
        const button = $(this);
