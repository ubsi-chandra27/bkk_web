...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="card card-flush mb-4">
        <div class="card-body py-4">
            <form method="GET" action="<?= site_url('admin/data-tracer') ?>">
                <div class="row g-3 align-items-end">
                    <div class="col-12 col-md-3">
                        ...
                        <select name="jurusan" class="form-select form-select-solid">
                            ...
                            <?php foreach ($jurusanList ?? [] as $jurusan): ?>
                                <option value="<?= esc($jurusan['id']) ?>" <?= (string) ($filters['jurusan'] ?? '') === (string) $jurusan['id'] ? 'selected' : '' ?>>
                                    <?= esc($jurusan['kompetensi_keahlian']) ?>
                                    <?php if (!empty($jurusan['akronim'])): ?>
                                        (<?= esc($jurusan['akronim']) ?>)
                                    <?php endif ?>
                                </option>
                            <?php endforeach ?>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select name="angkatan" class="form-select form-select-solid">
                            <option value="">Semua Angkatan</option>
                            <?php foreach ($angkatanList ?? [] as $angkatan): ?>
                                <option value="<?= esc($angkatan['id']) ?>" <?= (string) ($filters['angkatan'] ?? '') === (string) $angkatan['id'] ? 'selected' : '' ?>>
                                    <?= esc($angkatan['tahun']) ?>
                                </option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select name="aktivitas" class="form-select form-select-solid">
                            <option value="">Semua Aktivitas</option>
                            <?php foreach ($aktivitasList ?? [] as $aktivitas): ?>
                                <option value="<?= esc($aktivitas['id']) ?>" <?= (string) ($filters['aktivitas'] ?? '') === (string) $aktivitas['id'] ? 'selected' : '' ?>>
                                    <?= esc($aktivitas['nama_aktivitas']) ?>
                                </option>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="col-12 col-md-3">
                        ...
                        <a href="<?= site_url('admin/data-tracer') ?>" class="btn btn-light">Reset</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow-sm mb-5 mb-xl-8">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-3 px-5 px-md-8">
            ...
            <div class="card-toolbar w-100 w-md-auto">
                <?= view('admin/data_tracer/modal_export', [
